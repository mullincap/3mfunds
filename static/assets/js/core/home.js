        ...
        .then(data => {
            ...
            // ---------- Destroy old chart ----------
                        ...
                        const options = {
                            ...
                            // Bar color + trendline color
                            colors: ["#26BF94", "#e5e7eb"],
                            ...
                            stroke: {
                                curve: "straight",
                                width: [0, 2]   // bars = 0, trendline = 2
                            },

                            markers: {
                                size: 0          // keep line clean
                            },
...
setInterval(loadHeaderAUM, 60_000); // every 60s
